...
<head>
    ...
    <style>
        ...
        .login-wrap.mode-login {
            max-width: 440px;
        }

        .login-wrap.mode-register {
            max-width: 680px;
        }
        ...
        .form-control {
            width: 100%;
            padding: 0.7rem 0 0.7rem 2.2rem !important;
        ...
        .input-group:focus-within i.main-icon {
            color: #000;
        }
    ...
    <div id="app" v-cloak>
        ...
        <div class="login-wrap" :class="'mode-' + mode">
            <div class="login-header">
                <img src="<?= BASE_URL ?>assets/premios/PREMIASURGASLOGO.png" alt="Logo PremiaSurgas"
                    class="login-logo">
                    ...
                    <div v-if="mode === 'login'" key="login">
                        <form @submit.prevent="handleLogin">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="form.usuario" class="form-control" placeholder="Ingrese su DNI" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <i :class="['bx', showPassword ? 'bx-hide' : 'bx-show', 'password-toggle']"
                            ...
                            <div style="text-align: center; margin-top: 2rem;">
                                <p style="color: #666; font-size: 0.9rem; font-weight: 300;">
                                    ¿Eres cliente nuevo?
                                    <a href="javascript:void(0)" @click="mode = 'register'"
                                        style="color: #000; font-weight: 700; text-decoration: none; margin-left: 5px;">Regístrate
                                        aquí</a>
                                </p>
                            </div>
                        </form>
                    ...
                    <div v-else key="register">
                        <form @submit.prevent="handleRegistro">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="regForm.dni" class="form-control" maxlength="8" placeholder="Ingrese su DNI" required
                                    @input="onDniInput">
                            </div>
                            ...
                            <div class="input-group">
                                <label class="form-label">
                                    Nombre Completo
                                    <span v-if="buscandoDni" style="color:#000;font-size:0.65rem;margin-left:10px;"><i
                                            class='bx bx-loader-alt bx-spin'></i></span>
                                </label>
                                <i class='bx bx-user main-icon'></i>
                                <input type="text" v-model="regForm.nombre" class="form-control" placeholder="Ingrese su nombre completo" required>
                            </div>

                            <div class="input-group">
                                <label class="form-label">Celular</label>
                                <i class='bx bx-phone main-icon'></i>
                                <input type="text" v-model="regForm.celular" class="form-control" maxlength="9"
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group">
                                    <label class="form-label">Contraseña</label>
                                    <i class='bx bx-lock-alt main-icon'></i>
                                    <input :type="showPasswordReg ? 'text' : 'password'" v-model="regForm.password"
                                        class="form-control" placeholder="Cree una contraseña" required>
                                    <i :class="['bx', showPasswordReg ? 'bx-hide' : 'bx-show', 'password-toggle']"
                            ...
                            <div style="text-align: center; margin-top: 2rem;">
                                <p style="color: #666; font-size: 0.9rem; font-weight: 300;">
                                    ¿Ya tienes cuenta?
                                    <a href="javascript:void(0)" @click="mode = 'login'"
                                        style="color: #000; font-weight: 700; text-decoration: none; margin-left: 5px;">Inicia
                                        sesión</a>
                                </p>
                            </div>
                        </form>
