...
<body onload="initLayout()">
    ...
    <div class="admin-layout">
        ...
        <div class="container">
            ...
            <div class="scan-wrapper">
                ...
                <!-- ── Card 1: Búsqueda QR ── -->
                <div class="card" id="card-busqueda-qr" style="margin-bottom: 0;">
                            ...
                            <div class="elite-card-main" style="flex: 1; padding: 2.5rem; background: #fff; display: flex; flex-direction: column; gap: 2rem;">
                                ...
                                <div id="pv-special-section" style="display: none; background: #fff; border: 2.5px solid #e2e8f0; border-radius: 24px; padding: 2rem; margin-bottom: 0.5rem;">
                                    ...
                                    <div style="margin-bottom: 1.25rem;">
                                        ...
                                        <div id="evidencia-preview-container" style="display: none; margin-top: 15px; text-align: center;">
                                            <img id="evidencia-preview-img" style="max-width: 100%; max-height: 300px; border-radius: 12px; border: 2px solid #e2e8f0;">
                                        </div>
                                    </div>
    ...
    <script>
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.cliente.tipo_cliente === 'Punto de Venta') {
                        ...
                        document.getElementById('card-busqueda-qr').style.display = 'none';
                        const sidePanel = document.querySelector('.elite-card-side');
        ...
        function previewEvidencia(event) {
        ...
        async function setupPuntoDeVentaFlow(cliente) {
            ...
            // Remove balloon verifications functions
