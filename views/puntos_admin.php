            ...
            <div class="card" style="margin-top: 2rem; margin-bottom:0;">
                <div class="card-header" onclick="togglePending()">
                    ...
                    <div style="display:flex; align-items:center; gap:0.65rem;">
                        <span class="pending-badge"><?= $numPendientes ?>
                            pendiente<?= $numPendientes !== 1 ? 's' : '' ?></span>
                        <i id="pendingChevron"
                            class='bx bx-chevron-down toggle-chevron <?= $numPendientes > 0 ? 'open' : '' ?>'
                            ...
                            <?php foreach ($ventas as $r): ?>
                                <li class="ticket-card">
                                    ...
                                    <div class="ticket-amounts">
                                        <div class="pts-val"><i class='bx bxs-up-arrow-circle'></i>
                                            <?= number_format($r['puntos']) ?> pts</div>
                                    ...
                                    <div class="ticket-actions" style="display:flex; gap:0.5rem; align-items:center;">
                                        <form action="<?= BASE_URL ?>puntos-admin/actualizar" method="POST"
                                        ...
                                        <form action="<?= BASE_URL ?>puntos-admin/actualizar" method="POST" style="margin:0;"
                                            class="reject-form">
                                            <input type="hidden" name="id" value="<?= $r['id'] ?>">
                                            <input type="hidden" name="estado" value="rechazado">
                                            <button type="button" class="btn btn-danger-ghost btn-reject-trigger"
                                                title="Rechazar">
                ...
                <div class="clientes-toolbar-filters">
                    <div class="section-title-flex">
                        <div class="section-title-text">
                            <h3 style="margin: 0; font-size: 1.1rem; font-weight: 800; color: #0f172a;">Historial de
                                Validación</h3>
                            <span style="font-size: 0.75rem; color: #64748b; font-weight: 500;">Panel de validación de
                                puntos</span>
                        </div>
                    </div>
                </div>
                <div class="clientes-toolbar-search"
                    style="flex: 1; justify-content: flex-end; gap: 0.75rem; flex-wrap: wrap;">
                    ...
                    <div class="header-search-modern clientes-search-input" style="max-width: 280px;">
                        ...
                        <input type="text" id="historySearch" placeholder="Buscar por cliente..."
                    ...
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php foreach ($historial as $h):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="client-name"><?= htmlspecialchars($h['cliente_nombre'] ?? '-') ?></span>
                                            </td>
                                            <td><span style="color: var(--on-surface);">+<?= number_format($h['puntos']) ?>
                                                    pts</span></td>
                                            ...
                                            <td style="text-align: center !important;"><span class="chip <?= $chipClass ?>"><i
                                                    ...
                                                    <?= ucfirst($h['estado'] ?? 'pendiente') ?></span></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                        ...
                        <div class="card-footer-premium">
                            <div class="footer-info">
                                Mostrando <span id="pagStart">0</span> - <span id="pagEnd">0</span> de <span
                                    id="pagTotal">0</span> movimientos
                            </div>
